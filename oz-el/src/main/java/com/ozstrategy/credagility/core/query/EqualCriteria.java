 ...
 */
public class EqualCriteria extends LogicCriteria {
  //~ Instance fields --------------------------------------------------------------------------------------------------
   ...
   * @param  value  Object
   */
  public EqualCriteria(String name, Object value) {
    super(name, value);
  }
   ...
   */
  public EqualCriteria(String name, Object value, boolean ignoreCase) {
    super(name, value);
