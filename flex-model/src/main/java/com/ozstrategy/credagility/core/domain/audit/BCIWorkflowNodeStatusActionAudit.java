 ...
 * @version  07/24/2015 17:08
 */
@Entity public class BCIWorkflowNodeStatusActionAudit extends CreatorEntity {
  //~ Instance fields --------------------------------------------------------------------------------------------------
   ...
   */
  public BCIWorkflowNodeStatusActionAudit() { }
   ...
   */
  public BCIWorkflowNodeStatusActionAudit(BCIWorkflowNodeStatusAction action, AuditType type) {
...
} // end class BCIWorkflowNodeStatusActionAudit
