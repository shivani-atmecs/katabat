 ...
 * @version  08/18/2015 17:22
 */
@Entity
@Table(name = "AgencyNodeUpdateAction")
public class AgencyNodeUpdateAction extends BaseNodeAction implements Serializable {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = 6075709990427355565L;
  ...
  /**
   * Creates a new AgencyNodeUpdateAction object.
   */
  public AgencyNodeUpdateAction() {
   ...
   * duplicate.
   *
   * @return  AgencyNodeUpdateAction
   */
  @Override public AgencyNodeUpdateAction duplicate() {
    AgencyNodeUpdateAction updateAction = new AgencyNodeUpdateAction();
  ...
  @Override public boolean equals(Object o) {
    ...
    AgencyNodeUpdateAction that = (AgencyNodeUpdateAction) o;
...
} // end class AgencyNodeUpdateAction
