 ...
 * @version  10/22/2015 14:55
 */
@Entity
@Table(name = "AdditionalClientDefinedFields")
public class AdditionalClientDefinedFields extends CreatorEntity {
  //~ Instance fields --------------------------------------------------------------------------------------------------
  ...
  @Override public boolean equals(Object o) {
    ...
    if (!(o instanceof AdditionalClientDefinedFields)) {
      return false;
    }
    ...
    AdditionalClientDefinedFields that = (AdditionalClientDefinedFields) o;
...
} // end class AdditionalClientDefinedFields
