...
/**
 * This class is used to store AgencyUploadDocumentBlob information.
 *
 * @author   <a href="mailto:chenglong.du@ozstrategy.com">Chenglong Du</a>
 * @version  10/16/2014 14:47
 */
@Entity
@Table(name = "AgencyUploadDocumentBlob")
public class AgencyUploadDocumentBlob extends BasicUploadDocumentBlob implements Serializable {
  ...
  private AgencyDocumentInstance documentInstance;
  ...
  @Override public boolean equals(Object o) {
    ...
    AgencyUploadDocumentBlob that = (AgencyUploadDocumentBlob) o;
   ...
   */
  public AgencyDocumentInstance getDocumentInstance() {
  ...
  @Override public void updateDocumentInstance(BasicDocumentInstance docInstance) {
    setDocumentInstance((AgencyDocumentInstance) docInstance);
  }
} // end class AgencyUploadDocumentBlob
