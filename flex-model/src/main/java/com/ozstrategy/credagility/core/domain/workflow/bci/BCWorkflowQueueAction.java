...
/**
 * Created with IntelliJ IDEA. User: weitang Date: 14-8-5 Time: PM4:34 To change this template use File | Settings |
 * File Templates.
 *
 * @author   $author$
 ...
 */
@Entity
@Table(name = "BCWorkflowQueueAction")
public class BCWorkflowQueueAction extends BCWorkflowAction {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = -4301469533653341396L;
  ...
  @Override public boolean equals(Object o) {
    ...
    BCWorkflowQueueAction that = (BCWorkflowQueueAction) o;
...
} // end class BCWorkflowQueueAction
