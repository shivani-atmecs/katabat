...
import com.ozstrategy.credagility.core.domain.SurveyFlowStatusAction;
 ...
 * @version  07/24/2015 17:23
 */
@Entity public class SurveyFlowStatusActionAudit extends CreatorEntity {
  //~ Instance fields --------------------------------------------------------------------------------------------------
   ...
   */
  public SurveyFlowStatusActionAudit() { }
   ...
   */
  public SurveyFlowStatusActionAudit(SurveyFlowStatusAction action, AuditType type) {
...
} // end class SurveyFlowStatusActionAudit
