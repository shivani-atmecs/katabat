 ...
 * @version  10/16/2014 13:43
 */
@Entity
@Table(
  name    = "PortfolioCallingLimits",
  indexes = {
    @Index(
      name = "FK90_portfolioId",
      columnList = "portfolioId"
    )
  }
)
public class PortfolioCallingLimits extends CreatorEntity {
  //~ Instance fields --------------------------------------------------------------------------------------------------
...
} // end class PortfolioCallingLimits
