...
/**
 * This class is used to store EnterpriseUploadDocumentBlob information.
 *
 * @author   <a href="mailto:chenglong.du@ozstrategy.com">Chenglong Du</a>
 * @version  10/16/2014 14:59
 */
@Entity
@Table(name = "EnterpriseUploadDocumentBlob")
public class EnterpriseUploadDocumentBlob extends BasicUploadDocumentBlob implements Serializable {
  ...
  private EnterpriseDocumentInstance documentInstance;
  ...
  @Override public boolean equals(Object o) {
    ...
    EnterpriseUploadDocumentBlob that = (EnterpriseUploadDocumentBlob) o;
   ...
   *
   * @return  EnterpriseDocumentInstance
   */
  public EnterpriseDocumentInstance getDocumentInstance() {
  ...
  @Override public void updateDocumentInstance(BasicDocumentInstance docInstance) {
    setDocumentInstance((EnterpriseDocumentInstance) docInstance);
  }
} // end class EnterpriseUploadDocumentBlob
