 ...
 * @version  10/16/2014 12:29
 */
public class BusinessContextProcessActionResult implements Comparable<BusinessContextProcessActionResult> {
  //~ Instance fields --------------------------------------------------------------------------------------------------
  ...
  /** TODO: DOCUMENT ME! */
  protected Long actionBciCounts = 0L;
  ...
  /** TODO: DOCUMENT ME! */
  @Column protected Long uniqueBciCounts = 0L;
   ...
   */
  @Override public int compareTo(BusinessContextProcessActionResult oResult) {
  ...
  @Override public boolean equals(Object o) {
    ...
    BusinessContextProcessActionResult that = (BusinessContextProcessActionResult) o;
  ...
  /**
   * getter method for action bci counts.
   *
   * @return  Long
   */
  public Long getActionBciCounts() {
    return actionBciCounts;
  }
  ...
  /**
   * setter method for action bci counts.
   *
   * @param  actionBciCounts  Long
   */
  public void setActionBciCounts(Long actionBciCounts) {
    this.actionBciCounts = actionBciCounts;
  }
  ...
  @Override public String toString() {
    ...
    sb.append(", actionBciCounts=").append(actionBciCounts);
    sb.append(", uniqueBciCounts=").append(uniqueBciCounts);
    sb.append('}');

    return sb.toString();
  } // end method toString
} // end class BusinessContextProcessActionResult
