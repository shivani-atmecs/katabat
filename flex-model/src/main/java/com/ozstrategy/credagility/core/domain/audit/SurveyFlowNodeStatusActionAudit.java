...
import com.ozstrategy.credagility.core.domain.SurveyFlowNodeStatusAction;
 ...
 * @version  07/24/2015 16:34
 */
@Entity public class SurveyFlowNodeStatusActionAudit extends CreatorEntity {
  //~ Instance fields --------------------------------------------------------------------------------------------------
  ...
  /**
   * Creates a new SurveyFlowNodeStatusActionAudit object.
   */
  public SurveyFlowNodeStatusActionAudit() { }
   ...
   */
  public SurveyFlowNodeStatusActionAudit(SurveyFlowNodeStatusAction action, AuditType type) {
...
} // end class SurveyFlowNodeStatusActionAudit
