...
import com.cmc.credagility.core.domain.assignmentaction.AgencyAssignmentRole;
 ...
 * @version  10/16/2014 10:22
 */
@Entity
@Table(
  name    = "AgencyAssignmentAction",
  indexes = {
    @Index(
...
public class AgencyAssignmentAction extends PortfolioBaseNodeAction {
  ...
  @ManyToMany(
    ...
    mappedBy = "nodeAgencyActions"
  )
  protected Set<Node> agencyNodes = new LinkedHashSet<Node>();
  ...
  @OneToMany(
    fetch         = FetchType.LAZY,
    mappedBy      = "agencyAssignmentAction",
    cascade       = { CascadeType.ALL, CascadeType.REMOVE },
    orphanRemoval = true
  )
  private Set<AgencyAssignmentRole> agencyAssignmentRoles = new LinkedHashSet<AgencyAssignmentRole>();
   ...
   */
  public AgencyAssignmentAction() {
    actionType = BaseNodeAction.ActionType_AGENCYASSIGN;
  }
   ...
   * @param  id  Long
   */
  public AgencyAssignmentAction(Long id) {
    this.id = id;
  }
  ...
  @Override public boolean equals(Object o) {
    ...
    if (!(o instanceof AgencyAssignmentAction)) {
      return false;
    }
    ...
    AgencyAssignmentAction that = (AgencyAssignmentAction) o;
...
// }
    ...
    if ((agencyAssignmentRoles != null) ? (!agencyAssignmentRoles.equals(that.agencyAssignmentRoles))
                                        : (that.agencyAssignmentRoles != null)) {
      return false;
    }
  ...
  /**
   * getter method for agency assignment roles.
   *
   * @return  Set
   */
  public Set<AgencyAssignmentRole> getAgencyAssignmentRoles() {
    return agencyAssignmentRoles;
  }

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * getter method for agency nodes.
   *
   * @return  Set
   */
  public Set<Node> getAgencyNodes() {
    return agencyNodes;
  }
...
// + ((assignAgents != null) ? assignAgents.hashCode() : 0);
    ...
    result = (31 * result)
      + ((agencyAssignmentRoles != null) ? agencyAssignmentRoles.hashCode() : 0);
  ...
  /**
   * setter method for agency assignment roles.
   *
   * @param  agencyAssignmentRoles  Set
   */
  public void setAgencyAssignmentRoles(Set<AgencyAssignmentRole> agencyAssignmentRoles) {
    this.agencyAssignmentRoles = agencyAssignmentRoles;
  }

  //~ ------------------------------------------------------------------------------------------------------------------

  /**
   * setter method for agency nodes.
   *
   * @param  agencyNodes  Set
   */
  public void setAgencyNodes(Set<Node> agencyNodes) {
  ...
  @Override public String toString() {
    ...
    sb.append("AgencyAssignmentAction{");
...
} // end class AgencyAssignmentAction
