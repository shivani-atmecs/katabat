 ...
 */
@Entity public class OrganizationLevelTwo extends OrganizationLevel {
  //~ Instance fields --------------------------------------------------------------------------------------------------

  @OneToMany(
    fetch    = FetchType.LAZY,
    mappedBy = "organizationLevelTwo"
  )
  ...
  /**
   * Creates a new OrganizationLevelTwo object.
   */
  public OrganizationLevelTwo() { }
   ...
   * @param  id  Long
   */
  public OrganizationLevelTwo(Long id) {
    super(id);
  }
...
} // end class OrganizationLevelTwo
