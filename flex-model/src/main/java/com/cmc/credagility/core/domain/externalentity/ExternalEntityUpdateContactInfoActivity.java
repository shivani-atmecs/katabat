 ...
 */
@Entity
@Table(name = "ExternalEntityUpdateContactInfoActivity")
public class ExternalEntityUpdateContactInfoActivity extends BaseEntity {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = 3456467001196906522L;
  ...
  @Override public boolean equals(Object o) {
    ...
    ExternalEntityUpdateContactInfoActivity that = (ExternalEntityUpdateContactInfoActivity) o;
...
} // end class ExternalEntityUpdateContactInfoActivity
