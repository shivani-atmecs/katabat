...
public class AuthorizedContactAddress extends BaseAuthorizedContactAddress {
   ...
   * deepCopy.
   *
   * @param  address  AuthorizedContactAddress
   */
  public void deepCopy(AuthorizedContactAddress address) {
    if (address != null) {
  ...
  @Override public boolean equals(Object obj) {
    ...
    final AuthorizedContactAddress other = (AuthorizedContactAddress) obj;
...
} // end class AuthorizedContactAddress
