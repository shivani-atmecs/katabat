 ...
 */
@MappedSuperclass public abstract class BaseAuthorizedContactPhone extends BaseAuthorizedContact
  implements GeneralContactPhone {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = 8317261569177840953L;
...
} // end class BaseAuthorizedContactPhone
