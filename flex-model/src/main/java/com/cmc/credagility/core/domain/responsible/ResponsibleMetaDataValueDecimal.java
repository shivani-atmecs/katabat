...
/**
 * This class is used to store ResponsibleMetaDataValueDecimal information.
 *
...
@Entity
@Table(
  name    = "ResponsibleMetaDataValueDecimal",
  indexes = {
    @Index(
...
public class ResponsibleMetaDataValueDecimal extends MetaDataValueDecimal {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  /** Use serialVersionUID for interoperability. */
  private static final long serialVersionUID = 3698938997375592733L;
...
} // end class ResponsibleMetaDataValueDecimal
