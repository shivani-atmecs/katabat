 ...
 */
@Entity public class OrganizationLevelOne extends OrganizationLevel {
  //~ Instance fields --------------------------------------------------------------------------------------------------

  @OneToMany(
    fetch    = FetchType.LAZY,
    mappedBy = "organizationLevelOne"
  )
  ...
  /**
   * Creates a new OrganizationLevelOne object.
   */
  public OrganizationLevelOne() { }
   ...
   * @param  id  Long
   */
  public OrganizationLevelOne(Long id) {
    super(id);
  }
...
} // end class OrganizationLevelOne
