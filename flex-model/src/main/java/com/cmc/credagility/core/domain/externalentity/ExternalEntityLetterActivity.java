...
@Entity
@Table(
  name    = "ExternalEntityLetterActivity",
  indexes = {
    @Index(
      name = "statusIndex",
      columnList = "status"
...
public class ExternalEntityLetterActivity extends BaseEntity {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = 3456467001196903955L;
  ...
  /** TODO: DOCUMENT ME! */
  @Column(
    name     = "addressTypeAttempted",
    length   = 255,
    nullable = true
  )
  protected String addressTypeAttempted;
  ...
  @Override public boolean equals(Object o) {
    ...
    ExternalEntityLetterActivity that = (ExternalEntityLetterActivity) o;
    ...
    if ((addressTypeAttempted != null) ? (!addressTypeAttempted.equals(that.addressTypeAttempted))
                                       : (that.addressTypeAttempted != null)) {
      return false;
    }
   ...
   * @return  DOCUMENT ME!
   */
  public String getAddressTypeAttempted() {
    return addressTypeAttempted;
  }
  ...
  @Override public int hashCode() {
    ...
    result = (31 * result) + ((addressTypeAttempted != null) ? addressTypeAttempted.hashCode() : 0);
   ...
   * DOCUMENT ME!
   *
   * @param  addressTypeAttempted  DOCUMENT ME!
   */
  public void setAddressTypeAttempted(String addressTypeAttempted) {
    this.addressTypeAttempted = addressTypeAttempted;
  }
...
} // end class ExternalEntityLetterActivity
