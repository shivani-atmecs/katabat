...
@Entity
@Table(
  name    = "BCIVariableMetaDataValueLong",
  indexes = {
    @Index(
      name = "long_value_idx",
      columnList = "value"
...
public class BCIVariableMetaDataValueLong extends MetaDataValueLong {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = -4773171496186916329L;
...
} // end class BCIVariableMetaDataValueLong
