 ...
 * @version  10/15/2014 09:55
 */
@Entity
@Table(
  name    = "TemporaryAuthorizedUserAddress",
  indexes = {
    @Index(
...
public class TemporaryAuthorizedUserAddress extends BaseAuthorizedUserAddress {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = -7755848962575056466L;
   ...
   * deepCopy.
   *
   * @param  address  TemporaryAuthorizedUserAddress
   */
  public void deepCopy(TemporaryAuthorizedUserAddress address) {
    if (address != null) {
  ...
  @Override public boolean equals(Object o) {
    ...
    TemporaryAuthorizedUserAddress that = (TemporaryAuthorizedUserAddress) o;
  ...
  @Override public String toString() {
    ...
    retValue.append("TemporaryAuthorizedUserAddress ( ").append(super.toString()).append(TAB).append("address = ")
...
} // end class TemporaryAuthorizedUserAddress
