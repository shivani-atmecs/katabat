...
@Entity
@Table(
  name    = "ExternalEntityIvrActivity",
  indexes = {
    @Index(
      name = "statusIndex",
      columnList = "status"
...
public class ExternalEntityIvrActivity extends BaseEntity {
  ...
  @Override public boolean equals(Object o) {
    ...
    ExternalEntityIvrActivity that = (ExternalEntityIvrActivity) o;
...
} // end class ExternalEntityIvrActivity
