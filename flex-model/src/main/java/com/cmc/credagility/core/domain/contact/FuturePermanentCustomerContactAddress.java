...
import com.cmc.credagility.core.domain.customer.BaseCustomerContactAddress;
import com.cmc.credagility.core.domain.type.ContactChannel;
import com.cmc.credagility.core.domain.type.ContactChannelType;


/**
 * This class is used to store customer level FuturePermanentCustomerContactAddress information.
 *
...
@Entity
@Table(
  name    = "FuturePermanentCustomerContactAddress",
  indexes = {
    @Index(
...
public class FuturePermanentCustomerContactAddress extends BaseCustomerContactAddress {
   ...
   */
  public void deepCopy(FuturePermanentCustomerContactAddress address) {
    if (address != null) {
  ...
  @Override public boolean equals(Object o) {
    ...
    FuturePermanentCustomerContactAddress that = (FuturePermanentCustomerContactAddress) o;
  ...
  @Override public String toString() {
    ...
    retValue.append("FuturePermanentCustomerContactAddress ( ").append(super.toString()).append(TAB).append(
...
} // end class FuturePermanentCustomerContactAddress
