...
@Entity
@Table(
  name    = "BCIVariableMetaDataValueInteger",
  indexes = {
    @Index(
...
public class BCIVariableMetaDataValueInteger extends MetaDataValueInteger {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = 6878576792329966529L;
...
} // end class BCIVariableMetaDataValueInteger
