...
@Entity
@Table(
  name    = "FuturePermanentAuthorizedUserPhone",
  indexes = {
    @Index(
      columnList = "phoneNum",
      name = "phoneNumIndex"
...
public class FuturePermanentAuthorizedUserPhone extends BaseAuthorizedUserPhone {
  ...
  public boolean businessEquals(Object obj) {
    ...
    final FuturePermanentAuthorizedUserPhone other = (FuturePermanentAuthorizedUserPhone) obj;
   ...
   * deepCopy.
   *
   * @param  phone  FuturePermanentAuthorizedUserPhone
   */
  public void deepCopy(FuturePermanentAuthorizedUserPhone phone) {
    if (phone != null) {
  ...
  @Override public boolean equals(Object o) {
    ...
    FuturePermanentAuthorizedUserPhone that = (FuturePermanentAuthorizedUserPhone) o;
  ...
  @Override public String toString() {
    ...
    retValue.append("FuturePermanentAuthorizedUserPhone ( ").append(super.toString()).append(TAB).append("phoneId = ")
  ...
  @Override protected void deepCopy(AbstractBaseContact baseContact) {
    ...
    FuturePermanentAuthorizedUserPhone phone = (FuturePermanentAuthorizedUserPhone) baseContact;
...
} // end class FuturePermanentAuthorizedUserPhone
