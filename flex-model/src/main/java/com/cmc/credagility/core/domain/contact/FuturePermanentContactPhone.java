...
/**
 * This class is used to store responsible level FuturePermanentContactPhone information.
 *
...
@Entity
@Table(
  name    = "FuturePermanentContactPhone",
  indexes = {
    @Index(
...
public class FuturePermanentContactPhone extends BaseContactPhone {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = 6324236594306304017L;
  ...
  public boolean businessEquals(Object obj) {
    ...
    final FuturePermanentContactPhone other = (FuturePermanentContactPhone) obj;
   ...
   */
  public void deepCopy(FuturePermanentContactPhone phone) {
    if (phone != null) {
  ...
  @Override public boolean equals(Object o) {
    ...
    FuturePermanentContactPhone that = (FuturePermanentContactPhone) o;
  ...
  @Override public String toString() {
    ...
    retValue.append("FuturePermanentContactPhone ( ").append(super.toString()).append(TAB).append("phoneId = ").append(
  ...
  @Override protected void deepCopy(AbstractBaseContact baseContact) {
    ...
    FuturePermanentContactPhone phone = (FuturePermanentContactPhone) baseContact;
...
} // end class FuturePermanentContactPhone
