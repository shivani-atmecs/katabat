...
public class AuthorizedContactPhone extends BaseAuthorizedContactPhone {
  ...
  public boolean businessEquals(Object obj) {
    ...
    final AuthorizedContactPhone other = (AuthorizedContactPhone) obj;
   ...
   * deepCopy.
   *
   * @param  phone  AuthorizedContactPhone
   */
  public void deepCopy(AuthorizedContactPhone phone) {
    if (phone != null) {
  ...
  @Override protected void deepCopy(AbstractBaseContact baseContact) {
    ...
    AuthorizedContactPhone phone = (AuthorizedContactPhone) baseContact;
...
} // end class AuthorizedContactPhone
