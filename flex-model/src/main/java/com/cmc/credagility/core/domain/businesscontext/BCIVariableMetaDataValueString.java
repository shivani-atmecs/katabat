 ...
 */
@Entity
@Table(name = "BCIVariableMetaDataValueString")
public class BCIVariableMetaDataValueString extends MetaDataValueString {
...
} // end class BCIVariableMetaDataValueString
