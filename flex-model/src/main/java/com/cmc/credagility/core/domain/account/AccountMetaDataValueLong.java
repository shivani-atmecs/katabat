 ...
 * @version  10/16/2014 10:38
 */
@Entity
@Table(
  name    = "AccountMetaDataValueLong",
  indexes = {
    @Index(
      name = "long_value_idx",
      columnList = "value"
...
public class AccountMetaDataValueLong extends MetaDataValueLong {
...
} // end class AccountMetaDataValueLong
