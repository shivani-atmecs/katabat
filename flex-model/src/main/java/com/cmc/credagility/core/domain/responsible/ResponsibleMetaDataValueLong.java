...
import com.cmc.credagility.core.domain.metadata.MetaDataValueLong;


/**
 * This class is used to store ResponsibleMetaDataValueLong information.
 *
...
@Entity
@Table(
  name    = "ResponsibleMetaDataValueLong",
  indexes = {
    @Index(
      name = "long_value_idx",
      columnList = "value"
...
public class ResponsibleMetaDataValueLong extends MetaDataValueLong {
...
} // end class ResponsibleMetaDataValueLong
