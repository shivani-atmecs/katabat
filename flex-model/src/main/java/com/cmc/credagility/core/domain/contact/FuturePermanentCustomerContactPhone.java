...
import com.cmc.credagility.core.domain.customer.BaseCustomerPhone;
...
/**
 * This class is used to store customer level FuturePermanentCustomerContactPhone information.
 *
...
@Entity
@Table(
  name    = "FuturePermanentCustomerContactPhone",
  indexes = {
    @Index(
...
public class FuturePermanentCustomerContactPhone extends BaseCustomerPhone {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = -3790735066425888840L;
  ...
  public boolean businessEquals(Object obj) {
    ...
    final FuturePermanentCustomerContactPhone other = (FuturePermanentCustomerContactPhone) obj;
   ...
   */
  public void deepCopy(FuturePermanentCustomerContactPhone phone) {
    if (phone != null) {
  ...
  @Override public boolean equals(Object o) {
    ...
    FuturePermanentCustomerContactPhone that = (FuturePermanentCustomerContactPhone) o;
  ...
  @Override public String toString() {
    ...
    retValue.append("FuturePermanentCustomerContactPhone ( ").append(super.toString()).append(TAB).append("phoneId = ")
  ...
  @Override protected void deepCopy(AbstractBaseContact baseContact) {
    ...
    FuturePermanentCustomerContactPhone phone = (FuturePermanentCustomerContactPhone) baseContact;
...
} // end class FuturePermanentCustomerContactPhone
