 ...
 * @version  10/17/2014 10:07
 */
@Entity
@Table(
  name    = "AgencyMetaDataValueDate",
  indexes = {
    @Index(
      name = "date_value_idx",
      columnList = "value"
...
public class AgencyMetaDataValueDate extends MetaDataValueDate {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = -4299788788603673227L;
...
} // end class AgencyMetaDataValueDate
