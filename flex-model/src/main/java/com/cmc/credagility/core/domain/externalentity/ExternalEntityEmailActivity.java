...
@Entity
@Table(
  name    = "ExternalEntityEmailActivity",
  indexes = {
    @Index(
      name = "statusIndex",
      columnList = "status"
...
public class ExternalEntityEmailActivity extends BaseEntity {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = 3456467001196907651L;
  ...
  @Override public boolean equals(Object o) {
    ...
    ExternalEntityEmailActivity that = (ExternalEntityEmailActivity) o;
...
} // end class ExternalEntityEmailActivity
