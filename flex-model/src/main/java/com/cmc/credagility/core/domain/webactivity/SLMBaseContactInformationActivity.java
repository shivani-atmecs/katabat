 ...
 * @version  10/16/2014 09:55
 */
public class SLMBaseContactInformationActivity extends BaseWebActivity {
  //~ Static fields/initializers ---------------------------------------------------------------------------------------

  private static final long serialVersionUID = -2991193421494401989L;
  ...
  /** TODO: DOCUMENT ME! */
  protected String emailAddressFlag;
  ...
  /** TODO: DOCUMENT ME! */
  protected String mobilePhoneFlag;
  ...
  /**
   * getter method for email address flag.
   *
   * @return  String
   */
  ...
  /**
   * getter method for mobile phone flag.
   *
   * @return  String
   */
  public String getMobilePhoneFlag() {
  ...
  /**
   * setter method for email address flag.
   *
   * @param  emailAddressFlag  String
   */
  ...
  /**
   * setter method for mobile phone flag.
   *
   * @param  mobilePhoneFlag  String
   */
  public void setMobilePhoneFlag(String mobilePhoneFlag) {
  ...
  /**
   * setter method for school phone.
   *
   * @param  schoolPhone  String
   */
...
} // end class SLMBaseContactInformationActivity
